...
const Tiffin = (props) => {
  ...
  return (
    ...
    <div class='card'>
      <div class='card-body'>
        <img
          src={'http://localhost:8082/admin' + '/images/' + tiffin.tiffinImage}
          class='card-img-top'
          alt='...'
        />
        ...
        <div class='d-grid gap-2 d-md-flex justify-content-md-end'>
          ...
          <button class='btn btn-primary' type='button' onClick={EditTiffin}>
            Edit Tiffin
          </button>
          <button class='btn btn-danger' type='button' onClick={DeleteTiffin}>
            Delete{' '}
          </button>
        </div>
      </div>
